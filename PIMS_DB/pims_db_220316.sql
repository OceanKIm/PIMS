...
CREATE TABLE IF NOT EXISTS `activity_attach_file` (
  `activity_file_no` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `activity_mail_push_log` (
  `mail_push_no` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `activity_tb` (
  `actvity_no` int(11) NOT NULL AUTO_INCREMENT,
  `issue_no` int(11) NOT NULL,
  `emp_project_rltn_no` int(11) NOT NULL,
  `activity_content` text NOT NULL,
  `activity_st` varchar(1) NOT NULL DEFAULT 'R',
  `reg_dt` varchar(45) NOT NULL DEFAULT current_timestamp(),
  `mod_dt` varchar(45) NOT NULL DEFAULT current_timestamp(),
...
-- 테이블 pims.dev_position_info 구조 내보내기
CREATE TABLE IF NOT EXISTS `dev_position_info` (
...
CREATE TABLE IF NOT EXISTS `employee_tb` (
  ...
  `emp_st` varchar(2) NOT NULL DEFAULT 'W',
  `reg_dt` varchar(45) NOT NULL DEFAULT current_timestamp(),
  `mod_dt` varchar(45) NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`emp_no`),
...
CREATE TABLE IF NOT EXISTS `emp_project_rltn` (
  `emp_project_rltn_no` int(11) NOT NULL AUTO_INCREMENT,
  `emp_no` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `issue_attach_file` (
  `issue_file_no` int(11) NOT NULL AUTO_INCREMENT,
  `issue_no` int(11) NOT NULL,
...
-- 테이블 pims.issue_tb 구조 내보내기
CREATE TABLE IF NOT EXISTS `issue_tb` (
  ...
  `issue_st` varchar(1) NOT NULL DEFAULT 'R',
  `reg_dt` varchar(45) NOT NULL DEFAULT current_timestamp(),
  `mod_dt` varchar(45) NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`issue_no`,`issue_st`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE IF NOT EXISTS `project_attach_file` (
  `project_file_no` int(11) NOT NULL AUTO_INCREMENT,
  `project_code` int(11) NOT NULL,
...
-- 테이블 pims.project_pos_info 구조 내보내기
CREATE TABLE IF NOT EXISTS `project_pos_info` (
  `project_pos_cd` varchar(10) NOT NULL COMMENT '프로젝트 포지션 코드',
  `project_pos_nm` varchar(45) DEFAULT NULL COMMENT '프로젝트 포지션 이름',
  `project_pos_desc` text DEFAULT NULL COMMENT '프로젝트 포지션 설명',
  PRIMARY KEY (`project_pos_cd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='프로젝트 포지션 정보';
...
CREATE TABLE IF NOT EXISTS `project_tb` (
  ...
  `project_st` varchar(2) NOT NULL DEFAULT 'R',
  `reg_dt` varchar(45) NOT NULL DEFAULT current_timestamp(),
  `mod_dt` varchar(45) NOT NULL DEFAULT current_timestamp(),
...
-- 테이블 pims.project_type_info 구조 내보내기
CREATE TABLE IF NOT EXISTS `project_type_info` (
  `project_type_cd` varchar(10) NOT NULL COMMENT '프로젝트 타입 코드',
  `project_type_nm` varchar(45) DEFAULT NULL COMMENT '프로젝트 타입 이름',
  `project_type_desc` text DEFAULT NULL COMMENT '프로젝트 타입 설명',
  PRIMARY KEY (`project_type_cd`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='프로젝트 타입 정보';
