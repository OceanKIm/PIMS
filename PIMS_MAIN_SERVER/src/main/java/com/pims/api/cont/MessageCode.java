...
public enum MessageCode {
    ...
    RESULT_CODE_VALID_DUPLICATE_USER,                                                    // 이미 등록된 회원 이메일 입니다.
    ...
    RESULT_CODE_DUPLICATE_EMAIL_ID,                                                      // 중복된 email 아이디 입니다.
    RESULT_CODE_DUPLICATE_HP,                                                            // 중복된 휴대폰 번호 입니다.
    RESULT_CODE_NON_EXISTENT_EMAIL_ID,                                                   // 존재하지 않는 email 아이디 입니다.
    RESULT_CODE_NOT_EQUAL_PASSWORD                                                       // 패스워드가 맞지 않습니다.
